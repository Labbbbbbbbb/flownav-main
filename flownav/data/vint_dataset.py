...
class ViNT_Dataset(Dataset):
    ...
    def _build_caches(self, use_tqdm: bool = True):
        ...
        for traj_name in self.traj_names:  # Load all the trajectories into memory
            self._get_trajectory(traj_name)
        if not os.path.exists(cache_filename):  # Create cache if it doesn't exist
